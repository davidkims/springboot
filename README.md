...
- **파일 경로:** `.github/workflows/codespace-security-check.yml`
- **파일 크기:** 3684 바이트
- **파일 타입:** `text/plain`
- **특이사항:** 이 부분은 자동화된 코드 분석으로는 특이사항을 식별하지 못했습니다. 수동 검토가 필요합니다.

#### 📄 .github/workflows/codespace-security1-check.yml
- **파일 경로:** `.github/workflows/codespace-security1-check.yml`
- **파일 크기:** 3684 바이트
- **파일 타입:** `text/plain`
- **특이사항:** 이 부분은 자동화된 코드 분석으로는 특이사항을 식별하지 못했습니다. 수동 검토가 필요합니다.
...
- **파일 경로:** `.github/workflows/docker-ci-cd.yml`
- **파일 크기:** 7710 바이트
- **파일 타입:** `text/plain`
- **특이사항:** 민감 정보(password, secret 등) 키워드 발견 가능성. 주의 요망.
...
- **파일 경로:** `.github/workflows/generate_full_readme.yml`
- **파일 크기:** 13883 바이트
- **파일 타입:** `text/plain`
- **특이사항:** 민감 정보(password, secret 등) 키워드 발견 가능성. 주의 요망.
...
- **파일 경로:** `.github/workflows/update_readme1.yml`
- **파일 크기:** 5797 바이트
- **파일 타입:** `text/plain`
- **특이사항:** 민감 정보(password, secret 등) 키워드 발견 가능성. 주의 요망.

#### 📄 .github/workflows/workflow-health-monitor.yml
- **파일 경로:** `.github/workflows/workflow-health-monitor.yml`
- **파일 크기:** 6052 바이트
- **파일 타입:** `text/plain`
- **특이사항:** 민감 정보(password, secret 등) 키워드 발견 가능성. 주의 요망.
